...
import food from "@/public/icons/mcdonalds.svg";
            ...
            <div className="relative
                ...
                style={{ animation: "pulseIn 0.5s ease-in-out" }}>
                    ...
                    <div className="flex flex-col items-center justify-evenly
                            ...
                            <Image src={food} alt="Restaurante" className="w-2/3 h-fit"/>

                    </div>

                    <h1 className="text-[#754927] text-3xl">McDonald&apos;s</h1>

                    <h1 className="text-[#754927]
                               text-md text-center
                               md:text-xl">Ideal para refeições rápidas antes ou depois de explorar a orla!</h1>
                    ...
                    <div className="flex flex-row
                        ...
                        <div className="flex flex-row items-center justify-center gap-x-2
                            ...
                            <p className="text-[#754927] text-sm sm:text-md md:text-xl sm:before:content-['Abre:_']">09:00h</p>
                    ...
                    <div className="relative 
                            ...
                            <div className="flex flex-col gap-y-5 w-full h-full overflow-scroll overflow-x-auto">
                                <div className="flex flex-row items-center justify-start gap-x-2
                                        ...
                                        <p className="text-[#754927] text-md sm:text-xl md:text-2xl">Rua Milton de Holanda Maia, 61</p>
                                ...
                                <div className="flex flex-row items-center justify-start gap-x-2
                                        ...
                                        <p className="text-[#754927] text-md sm:text-xl md:text-2xl">Telefone: (12) 3941-1407</p>
                                ...
                                <div className="flex flex-row items-center justify-start gap-x-2
                                        ...
                                        <p className="text-[#754927] text-md sm:text-xl md:text-2xl">Fecha às 00:00h toda sexta e sábado.</p>
                                ...
                                <div className="flex flex-row items-center justify-start gap-x-2
                                        ...
                                        <a href="https://maps.app.goo.gl/FUAPq7iHy2qqi62RA" className="underline text-blue-700" target="__top">
