...
import food from "@/public/images/raizes.png";
            ...
            <div className="relative
                ...
                style={{ animation: "pulseIn 0.5s ease-in-out" }}>
                    ...
                    <div className="flex flex-col items-center justify-evenly
                            ...
                            <Image src={food} alt="Restaurante" className="w-[90%] h-fit"/>

                    </div>

                    <h1 className="text-[#754927] text-3xl">Restaurante Raízes</h1>

                    <h1 className="text-[#754927]
                               text-md text-center
                               md:text-xl">Ambiente elegante e drinques criativos em um restaurante refinado com frutos do mar e pizzas.</h1>
                    ...
                    <div className="flex flex-row
                        ...
                        <div className="flex flex-row items-center justify-center gap-x-2 
                            ...
                            <p className="text-[#754927] text-sm sm:text-md md:text-xl sm:before:content-['Fecha:_']">23:30h</p>
                    ...
                    <div className="relative 
                            ...
                            <div className="flex flex-col gap-y-5 w-full h-full overflow-auto">
                                <div className="flex flex-row items-center justify-start gap-x-2
                                        ...
                                        <p className="text-[#754927] text-md sm:text-xl md:text-2xl">Av. Leovigildo Dias Vieira, 1280</p>
                                ...
                                <div className="flex flex-row items-center justify-start gap-x-2
                                        ...
                                        <p className="text-[#754927] text-md sm:text-xl md:text-2xl">Telefone: (12) 3832-3377</p>
                                ...
                                <div className="flex flex-row items-center justify-start gap-x-2
                                        ...
                                        <a href="http://www.raizesubatuba.com/" className="underline text-blue-700" target="__top">
                                            <p className="text-md sm:text-xl md:text-2xl">http://www.raizesubatuba.com/</p>
                                        </a>
                                ...
                                <div className="flex flex-row items-center justify-start gap-x-2
                                        ...
                                        <a href="https://maps.app.goo.gl/ttTDNkMd5vs2mt2c9" className="underline text-blue-700" target="__top">
