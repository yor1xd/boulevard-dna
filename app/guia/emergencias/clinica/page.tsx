...
import microscope from "@/public/icons/microscope.svg";
            ...
            <div className="relative
                ...
                style={{ animation: "pulseIn 0.5s ease-in-out" }}>
                    ...
                    <div className="flex flex-col items-center justify-evenly
                            ...
                            <Image src={microscope} alt="Farmácia" className="h-1/2 w-fit"/>
                            <p className="text-[#754927]">Clínica</p>

                    </div>

                    <h1 className="text-[#754927] text-2xl sm:text-3xl">Policlínica Itaguá</h1>
                    ...
                    <div className="flex flex-row
                        ...
                        <div className="flex flex-row items-center justify-center gap-x-2
                            ...
                            <p className="text-[#754927] text-sm sm:text-md md:text-xl before:content-['Abre:_']">08h</p>
                        ...
                        <div className="flex flex-row items-center justify-center gap-x-2 
                            ...
                            <p className="text-[#754927] text-sm sm:text-md md:text-xl before:content-['Fecha:_']">21h</p>
                    ...
                    <div className="relative 
                            ...
                            <div className="flex flex-col gap-y-5  w-full h-full overflow-auto">
                                <div className="flex flex-row items-center justify-start gap-x-2
                                        ...
                                        <p className="text-[#754927] text-md sm:text-xl md:text-2xl">Rua Joaquim Nabuco, número 329.</p>
                                ...
                                <div className="flex flex-row items-center justify-start gap-x-2
                                        ...
                                        <p className="text-[#754927] text-md sm:text-xl md:text-2xl">Distância de 700m do apartamento.</p>
                                ...
                                <div className="flex flex-row items-center justify-start gap-x-2
                                        ...
                                        <p className="text-[#754927] text-md sm:text-xl md:text-2xl">Telefone: (12) 3833-4841</p>
                                
                                </div>
                                <div className="flex flex-row items-center justify-start gap-x-2
                                                w-fit h-10">
                                
                                        <Image src={clock} alt="Endereço" className="h-2/3 w-fit"/>
                                        <p className="text-[#754927] text-md sm:text-xl md:text-2xl">Aberto de segunda à sexta.</p>
                                ...
                                <div className="flex flex-row items-center justify-start gap-x-2
                                        ...
                                        <a href="https://maps.app.goo.gl/nuQDxip81x5rwNF69" className="underline text-blue-700" target="__top">
