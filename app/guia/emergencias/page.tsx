        ...
        <div className="relative flex h-[calc(100vh_-_4rem)] sm:h-[calc(100vh_-_5rem)]">
            ...
            <div className="relative flex flex-col items-center justify-evenly
                ...
                <h1 className="font-brittany text-[#754927]
                               text-3xl
                               md:text-4xl
                               lg:text-5xl my-10">Emergências</h1>

                <h1 className="text-[#754927]
                               text-md text-center
                               md:text-xl">Aqui você pode encontrar detalhes sobre os locais de saúde mais próximas de você!</h1>

                <h1 className="text-[#754927]
                               text-md text-center
                               md:text-xl">Selecione uma das categorias para ver mais!</h1>
                ...
                <div className="flex flex-row justify-evenly items-center
                    ...
                    <button className="flex flex-col items-center justify-evenly
                            ...
                            onClick={() => redirect("/guia/emergencias/hospital")}>

                        <Image src={medic} alt="Casa" className="h-1/2 w-fit"/>
                        <p className="max-w-[90%] text-ellipsis overflow-hidden text-[#754927]">Hospital</p>
                    </button>
                    ...
                    <button className="flex flex-col items-center justify-evenly
                                       ...
                                       bg-white rounded-2xl border-2 border-[#754927] shadow-2xl
                                       transition-transform hover:scale-105 active:scale-100"
                            onClick={() => redirect("/guia/emergencias/farmacia")}>

                        <Image src={pill} alt="Casa" className="h-1/2 w-fit"/>
                        <p className="max-w-[90%] text-ellipsis overflow-hidden text-[#754927]">Farmácia</p>
                    </button>
                    ...
                    <button className="flex flex-col items-center justify-evenly
                                       ...
                                       bg-white rounded-2xl border-2 border-[#754927] shadow-2xl
                                       transition-transform hover:scale-105 active:scale-100"
                            onClick={() => redirect("/guia/emergencias/clinica")}>

                        <Image src={microscope} alt="Casa" className="h-1/2 w-fit"/>
                        <p className="max-w-[90%] text-ellipsis overflow-hidden text-[#754927]">Clínica</p>
                    </button>
